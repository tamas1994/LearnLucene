...
public class IndexFiles {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (create) {
				// Create a new index in the directory, removing
				// any
	 ...
	 * An example of this is in the benchmark module, which can create
	 * "line doc" files, one document per line, using the <a href=
	 * "../../../../../contrib-benchmark/org/apache/lucene/benchmark/byTask/tasks/WriteLineDocTask.html"
	 * >WriteLineDocTask</a>.
	 * 
	 * @param writer
	 *                Writer to the index where the given file/dir info will
	 *                be stored
	 * @param path
	 *                The file to index, or the directory to recurse into to
	 *                find files to index
	 * @throws IOException
